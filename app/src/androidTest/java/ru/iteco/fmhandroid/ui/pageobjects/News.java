...
public class News {
    ...
    public static ViewInteraction titleTextView(String title) {
    ...
    public static ViewInteraction editNewsItem = onView(allOf(withId(R.id.edit_news_item_image_view), withParent(withParent(allOf(withId(R.id.news_item_material_card_view), withChild(withChild(withText("News editing button"))))))));


    public static ViewInteraction deleteButton(String title) {
    ...
    public static ViewInteraction itemTitleText = onView(allOf(withId(R.id.news_item_title_text_input_edit_text)));
}
